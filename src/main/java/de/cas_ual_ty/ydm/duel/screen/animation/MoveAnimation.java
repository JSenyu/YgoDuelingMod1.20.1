...
public class MoveAnimation extends Animation
{
    ...
    public void render(GuiGraphics gui, int mouseX, int mouseY, float partialTicks)
    {
        ...
        gui.pose().mulPose(new Quaternionf(new AxisAngle4f(rotation, 0.0f, 0.0f, 1.0f)));
        
        // we always render the card position straight and manually rotate it, thats why we use fullBlit here
        CardRenderUtil.renderDuelCardAdvanced(gui, sleeves, mouseX, mouseY, (int) (-cardWidth / 2), -cardSize / 2, (int) cardWidth, (int) (float) cardSize, duelCard, cardPosition,
