...
public class DuelManager
{
    ...
    {
        PlayerRole role = getRoleFor(player);
        setPlayerOffersDraw(player, role, role == PlayerRole.PLAYER1 ? !player1OfferedDraw : (role == PlayerRole.PLAYER2 && !player2OfferedDraw));
    ...
    {
        doForAllPlayers(this::sendDuelStateTo);
    }
