...
public enum CardSleevesType
{
    ...
    MASTER_PEACE("master_peace"),
    HERO("hero"),
    DESTINY_HERO("destiny_hero"),
    P_1("p_1", "Lucifer"),
    KINGDOMS_MC("kingdoms_mc"),
    DUELIST_ACADEMY_NETWORK("duelist_academy_network"),
    P_2("p_2", "LuisRavenFlame1"),
    P_3("p_3", "LuisRavenFlame1"),
    DUELING_MC("dueling_mc");
