...
public class YdmDatabase {
    ...
    public static final DNCList<String, RarityEntry> RARITIES_LIST = new DNCList<>((r) -> r.rarity, String::compareTo);
    public static final DNCList<String, Distribution> DISTRIBUTIONS_LIST = new DNCList<>((d) -> d.name, String::compareTo);
    public static final DNCList<String, CardSet> SETS_LIST = new DNCList<>((s) -> s.code, String::compareTo);
